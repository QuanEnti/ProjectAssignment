            ...
            <div class="col-md-6">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">Hệ thống quản lý thời trang</small>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex justify-content-md-end justify-content-start align-items-center">
                    <div class="footer-links me-4">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/docs" class="text-decoration-none text-muted hover-primary">
                            <i class="bi bi-book me-1"></i>Tài liệu
                        </a>
                    </div>
                    <div class="system-status">
                        <div class="d-flex align-items-center">
                            <div class="status-indicator bg-success rounded-circle me-2" style="width: 8px; height: 8px;"></div>
                            <small class="text-success fw-semibold">Hệ thống hoạt động bình thường</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="d-flex align-items-center">
                    <small class="text-muted">
                        © 2024 <strong class="text-primary">FashionShop</strong>. Tất cả quyền được bảo lưu.
                    </small>
                </div>
            </div>
                ...
                <div class="d-flex justify-content-md-end justify-content-start align-items-center">
                    <div class="admin-stats me-4">
                        <small class="text-muted d-flex align-items-center">
                            ...
                            Phiên bản: <span class="text-primary fw-semibold ms-1">v2.1.0</span>
                        </small>
                    </div>
